...
* **`Electricity_Forecasting.ipynb`**: The complete research and development notebook covering EDA, modeling, and evaluation.
...
* **`featured_project.png`**: Comparative visualization showcasing the 2.32% MAPE fit (Predicted vs. Actual demand).
